// <copyright file="PrincipalHasOperatorTest.cs" company="Kyubisation">
...
namespace FluentRestBuilder.Test.Operators
{
    ...
    public class PrincipalHasOperatorTest
    {
        [Fact]
        public async Task TestValidCase()
        {
            ...
            var observable = new SingleObservable<string>(
                ...
                .PrincipalHas((p, i) => p.HasClaim(claimType, expected));
        ...
        public async Task TestInvalidCase()
        {
            ...
            var observable = new SingleObservable<string>(
                expected, collection.BuildServiceProvider())
                .PrincipalHas((p, i) => p.HasClaim("claim", expected));
        ...
        public void TestProvider()
        {
            ...
            var observable = new SingleObservable<string>(
                ...
                .PrincipalHas((p, s) => s == string.Empty);
