// <copyright file="NotFoundWhenAsyncAliases.cs" company="Kyubisation">
...
namespace FluentRestBuilder.Operators
{
    ...
    public static class NotFoundWhenAsyncAliases
    {
        /// <summary>
        ...
        public static IProviderObservable<TSource> NotFoundWhenAsync<TSource>(
            ...
            observable.InvalidWhenAsync(invalidCheck, StatusCodes.Status404NotFound, errorFactory);
