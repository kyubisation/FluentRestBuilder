// <copyright file="PrincipalHasOperator.cs" company="Kyubisation">
...
namespace FluentRestBuilder.Operators
{
    ...
    public static class PrincipalHasOperator
    {
        /// <summary>
        /// Emits an error if the principal (the current user) check fails. Otherwise emits the value.
        ...
        public static IProviderObservable<TSource> PrincipalHas<TSource>(
            this IProviderObservable<TSource> observable,
            Func<ClaimsPrincipal, TSource, bool> principalCheck,
            Func<TSource, object> errorFactory = null) =>
            new PrincipalHasObservable<TSource>(principalCheck, errorFactory, observable);

        private sealed class PrincipalHasObservable<TSource> : Operator<TSource, TSource>
        {
            private readonly Func<ClaimsPrincipal, TSource, bool> principalCheck;
            private readonly Func<TSource, object> errorFactory;

            public PrincipalHasObservable(
                Func<ClaimsPrincipal, TSource, bool> principalCheck,
                ...
                IObserver<TSource> observer, IDisposable disposable)
            {
                ...
                return new PrincipalHasObserver(
            ...
            private sealed class PrincipalHasObserver : SafeObserver
            {
                private readonly ClaimsPrincipal principal;
                private readonly Func<ClaimsPrincipal, TSource, bool> principalCheck;
                private readonly Func<TSource, object> errorFactory;

                public PrincipalHasObserver(
