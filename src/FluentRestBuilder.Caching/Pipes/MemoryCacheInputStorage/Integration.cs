...
namespace FluentRestBuilder
{
    ...
    {
        public static IFluentRestBuilderCoreConfiguration RegisterMemoryCacheInputStoragePipe(
        ...
        public static OutputPipe<TInput> StoreInputInMemoryCache<TInput>(
            ...
            where TInput : class
        {
            var factory = pipe.GetService<IMemoryCacheInputStoragePipeFactory<TInput>>();
            Check.IsPipeRegistered(factory, typeof(MemoryCacheInputStoragePipe<>));
